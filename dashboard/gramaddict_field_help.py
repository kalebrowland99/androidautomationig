...
CONFIG_HELP: dict[str, str] = {
    ...
    "daily-story-likes": "Visit accounts in story_likes.txt once per day (use can-reinteract-after: 24). Likes all segments in any new story, then moves to the next account.",
    ...
    "post-reels": "How many reel videos you plan to post. The bot posts 1 per session, rotating through your queue, before other jobs. Upload videos on Jobs when this is above 0. Locked to 0 for @615films and @yourlovefilms.",
    ...
    "skip-top-profile-posts": "Skip the first N posts on a profile grid (default 3). Does not detect pin badges — it always skips the top slots.",
...
FILTER_HELP: dict[str, str] = {
    ...
    "blacklist_words": "Skip if their bio or name contains any of these words (one per line).",
