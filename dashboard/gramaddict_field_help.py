...
CONFIG_HELP: dict[str, str] = {
    ...
    "post-reels": "How many reel videos you plan to post. The bot posts 1 per session, rotating through your queue, before other jobs. Upload videos on Jobs when this is above 0.",
