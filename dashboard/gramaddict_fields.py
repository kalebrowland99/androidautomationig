...
EDITABLE_FIELDS: dict[str, list[dict[str, Any]]] = {
    ...
    "source_limits": [
        ...
        {
            "key": "comment-cooldown-days",
            "label": "Don't comment on same person again for (days)",
            "type": "text",
            "default": "7",
            "placeholder": "7",
        },
        ...
        {"key": "skip-first-row", "label": "Skip first row on profile grid", "type": "bool"},
    ...
    "session_limits": [
        ...
        {"key": "total-follows-limit-daily", "label": "Max follows per DAY (0 = off)", "type": "text", "default": "0"},
        {"key": "daily-liked-posts-goal", "label": "Today Liked Posts goal (display only)", "type": "text", "default": "0"},
        {"key": "daily-liked-stories-goal", "label": "Today Liked Stories goal (display only)", "type": "text", "default": "0"},
        {"key": "daily-follows-goal", "label": "Today Followed goal (display only)", "type": "text", "default": "0"},
